...
if __name__ == '__main__':
    ...
    parser.add_argument('--pause_instance', help = 'Want to pause instance after training', \
        action='store_true', dest='pause_instance')
    parser.add_argument('--no_pause_instance', help = 'Want to pause instance after training', \
        action='store_false', dest='pause_instance')
