...
@dataclass
class Config:
  LOG_LEVELS: dict = field(default_factory=lambda:{
  ...
  SURFACES: set = field(default_factory=lambda:{'CALIB', 'FE', 'CS', 'StrU', 'StrD', 'SlpU', 'SlpD', 'BnkL', 'BnkR', 'GR'})
  SENSOR_LOCS: dict = field(default_factory=lambda:{
        'Trunk':          'CC'
      , 'Wrist':          '95'
      , 'RightThigh':     '93'
      , 'LeftThigh':      '8B'
